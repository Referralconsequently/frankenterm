...
RCH_PROBE_LOG="${LOG_DIR}/scenario_matrix_${RUN_ID}.probe.log"
RCH_SMOKE_LOG="${LOG_DIR}/scenario_matrix_${RUN_ID}.smoke.log"
...
compile_log="${LOG_DIR}/ft_1i2ge_7_1_${RUN_ID}.compile.log"
set +e
run_rch_cargo_logged "${compile_log}" \
  check -p frankenterm-core --features subprocess-bridge \
  --test mission_e2e_scenario_matrix
compile_rc=$?
set -e
...
tests_log="${LOG_DIR}/ft_1i2ge_7_1_${RUN_ID}.tests.log"
set +e
...
clippy_log="${LOG_DIR}/ft_1i2ge_7_1_${RUN_ID}.clippy.log"
set +e
...
repeat_log="${LOG_DIR}/ft_1i2ge_7_1_${RUN_ID}.tests_repeat.log"
set +e
