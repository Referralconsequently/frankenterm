...
# E2E scenario: validate impact attribution tests compile, pass, are clippy-clean,
# cover all impact categories, and produce deterministic results.
...
SCENARIO_ID="ft_1i2ge_6_8_impact_attribution"
...
emit_log() {
  ...
  jq -cn \
    --arg timestamp "${ts}" \
    --arg component "impact_attribution.e2e" \
