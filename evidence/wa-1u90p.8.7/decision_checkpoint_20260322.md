# Decision Checkpoint — 2026-03-22 (`ft-1u90p.8.7`)
...
- Guardrail validation run:
  - executed at `2026-03-23T01:19:29Z` (`2026-03-22T21:19:29-04:00` local)
  - baseline case correctly remains `HOLD`
  - run-id and feedback-id evidence joins remain consistent across the summary, feedback log, and correlation CSV
...
## Decision Rationale
The evidence pipeline, threshold-eligibility metadata contract, anomaly ledger schema, and promotion guardrails remain healthy and reproducible, but promotion is still blocked on real-user C2 sample sufficiency. `HOLD` remains the correct operational decision.
...
1. `sample-sufficiency-gap-2026-03-12`
   ...
   - Evidence: `evidence/wa-1u90p.8.7/cohort_daily_summary.json`, `evidence/wa-1u90p.8.7/telemetry_feedback_correlation.csv`, `tests/e2e/logs/ft_1u90p_8_7_20260322_211929.jsonl`
...
2. `fixture-only-feedback-source-2026-03-12`
   ...
   - Evidence: `evidence/wa-1u90p.8.7/beta_feedback_log.jsonl`, `evidence/wa-1u90p.8.7/telemetry_feedback_correlation.csv`, `evidence/wa-1u90p.8.7/decision_checkpoint_20260322.md`
