...
//! - `ft why <template_id>` returns structured explanations with remediation
...
//! # Related Beads
//!
//! - bd-6qum: E2E: ft why + enriched errors with verbose logging
//! - wa-2ep: [EPIC] Deep Explainability

use std::collections::HashMap;

use frankenterm_core::error_codes::{ErrorCategory, get_error_code, list_error_codes};
...
fn error_category_parsing_works() {
    ...
    assert_eq!(
        ErrorCategory::from_code("FT-2500"),
    ...
    // Test invalid codes
    assert!(ErrorCategory::from_code("FT-0001").is_none());
